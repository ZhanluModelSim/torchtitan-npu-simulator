...
def _make_dsv32_model_config(
    ...
    if inner_attention is None and mask_type == "block_causal":
    ...
    layers = _build_dsv32_layers(
        ...
        router_num_expert_groups=router_num_expert_groups,
        router_num_limited_groups=router_num_limited_groups,
