...
std::tuple<at::Tensor, at::Tensor> npu_lightning_indexer(
    ...
    const c10::optional<at::Tensor> &block_table, std::string layout_q, std::string layout_k, int64_t sparse_count,
  ...
  ACLNN_CMD(aclnnLightningIndexer, query, key, weights, actual_seq_q, actual_seq_k, block_table, layout_q_ptr,
            layout_k_ptr, sparse_count, sparse_mode, pre_tokens, next_tokens, cmp_ratio, return_values, sparse_indices,
            sparse_values);
