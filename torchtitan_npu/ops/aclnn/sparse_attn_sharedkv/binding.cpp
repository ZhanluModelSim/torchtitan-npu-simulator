// Adapted from:
// https://gitcode.com/Ascend/MindSpeed/blob/9f9eebfa28faf06ee97474a3c996f0fcd0897ea6/mindspeed/ops/csrc/cann/npu_sparse_attn_shared_kv.cpp
//
...
at::Tensor npu_sparse_attn_sharedkv_metadata(
    const c10::optional<at::Tensor> &cuSeqLensQ, const c10::optional<at::Tensor> &sequsedOriKv,
    const c10::optional<at::Tensor> &sequsedCmpKv, const c10::optional<at::Tensor> &sequsedQ,
    const c10::optional<at::Tensor> &sequsedKv, int64_t numHeadsQ, int64_t numHeadsKv, int64_t headDim,
  ...
  ACLNN_CMD(aclnnSparseAttnSharedkvMetadata, cuSeqLensQ, sequsedOriKv, sequsedCmpKv, sequsedQ, sequsedKv, numHeadsQ,
            ...
            cmpMaskMode, oriWinLeft, oriWinRight, layoutQPtr, layoutKvPtr, hasOriKv, hasCmpKv, metadata);
  return metadata;
}

std::tuple<at::Tensor, at::Tensor> npu_sparse_attn_sharedkv(
    const at::Tensor &query, const c10::optional<at::Tensor> &oriKv, const c10::optional<at::Tensor> &cmpKv,
    ...
    int64_t cmpMaskMode, int64_t oriKvStride, int64_t cmpKvStride, int64_t oriWinLeft, int64_t oriWinRight,
  ...
  ACLNN_CMD(aclnnSparseAttnSharedkv, query, oriKv, cmpKv, oriSparseIndices, cmpSparseIndices, oriBlockTable,
            ...
            layoutQPtr, layoutKvPtr, returnSoftmaxLse, attnOutput, softmaxLseOut);
...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_sparse_attn_sharedkv_grad(
    const at::Tensor &query, const at::Tensor &oriKv, const c10::optional<at::Tensor> &cmpKv,
    const c10::optional<at::Tensor> &dOut, const c10::optional<at::Tensor> &out, const c10::optional<at::Tensor> &lse,
    const c10::optional<at::Tensor> &oriSparseIndices, const c10::optional<at::Tensor> &cmpSparseIndices,
    const c10::optional<at::Tensor> &cuSeqlensQ, const c10::optional<at::Tensor> &cuSeqlensOriKv,
    const c10::optional<at::Tensor> &cuSeqlensCmpKv, const at::Tensor &sinks, double scaleValue, int64_t cmpRatio,
    int64_t oriMaskMode, int64_t cmpMaskMode, int64_t oriWinLeft, int64_t oriWinRight,
  ...
  ACLNN_CMD(aclnnSparseAttnSharedkvGrad, query, oriKv, cmpKv, dOut, out, lse, oriSparseIndices, cmpSparseIndices,
            cuSeqlensQ, cuSeqlensOriKv, cuSeqlensCmpKv, sinks, scaleValue, cmpRatio, oriMaskMode, cmpMaskMode,
            oriWinLeft, oriWinRight, layoutPtr, dQuery, dOriKv, dCmpKv, dSinks);
  return std::make_tuple(dQuery, dOriKv, dCmpKv, dSinks);
}

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("npu_sparse_attn_sharedkv_metadata", &npu_sparse_attn_sharedkv_metadata, "Shared-KV Sparse Attention Metadata");
  m.def("npu_sparse_attn_sharedkv", &npu_sparse_attn_sharedkv, "Shared-KV Sparse Attention Forward");
  m.def("npu_sparse_attn_sharedkv_grad", &npu_sparse_attn_sharedkv_grad, "Shared-KV Sparse Attention Backward");
}
