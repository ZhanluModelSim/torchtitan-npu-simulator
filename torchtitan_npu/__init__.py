...
def _apply_patches():
    ...
    from .models import block_diffusion, deepseek_v4, deepseek_v32, kimi_k3, vlm
    ...
    new_set.update(
        {"block_diffusion", "deepseek_v32", "deepseek_v4", "kimi_k3", "vlm"}
    )
    ...
    _inject_module("torchtitan.models.block_diffusion", block_diffusion)
