...
"""Shared fixtures and utilities for ParamSwap tests."""
...
def _expert_weight_filter(param, fqn):
    """A `params_filter_fn` for ParamSwapConfig: wraps only 3D expert weight parameters,
