...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            None,
            MXQuantizeConfig(),
            r"^Only `BlockQuantizeConfig` is supported for `weight_config` in BlockTrainingWeightWrapperTensor\.$",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            BlockQuantizeConfig(),
            None,
            r"^Only `MXQuantizeConfig` is supported for `activation_config` in BlockTrainingWeightWrapperTensor\.$",
        ),
        (
            BlockTrainingWeightWrapperTensor,
            None,
            None,
            r"^`weight_config` is required for BlockTrainingWeightWrapperTensor\.$",
        ),
        (
            BlockTrainingWeightWrapperTensor,
            None,
