...
# E2E perf benchmark for DSV4 Flash single-node QAT. See ./config_registry.py
# for the quantization rules.
#
...

{
  ...
  echo "CONFIG                 = ${CONFIG:-debug_deepseek_v4_flash_single_node_qat}"
  ...
  CONFIG="${CONFIG:-debug_deepseek_v4_flash_single_node_qat}" \
