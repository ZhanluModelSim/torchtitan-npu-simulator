...
| PR | 本地补丁 | 说明 |
| --- | --- | --- |
| [#3430](https://github.com/pytorch/torchtitan/pull/3430) | `distributed/` | 为变长注意力补充 CP 和 Full DTensor 支持。 |
| [#3634](https://github.com/pytorch/torchtitan/pull/3634) | `components/`、`models/`、`trainer.py` | 补充 DeepSeek-V4 所需的公共组件及训练接入。 |
