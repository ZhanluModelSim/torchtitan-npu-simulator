#!/usr/bin/env python3
"""Run DeepSeek V4 PP4+CP4 simulation and apply the host-only GE-catalog fusion
pass to each PP rank's captured StepGraph, printing before/after compression
...
def _worker(rank, nproc, sim_ws):
    ...
    os.environ["MASTER_PORT"] = os.environ.get("MASTER_PORT", "29504")
    ...
    def patched_build(self, *a, **kw):
        ...
        trainer.simulation_config.enable_fusion = True
        return trainer
