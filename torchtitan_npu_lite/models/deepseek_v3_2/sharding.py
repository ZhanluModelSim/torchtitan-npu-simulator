...
if TYPE_CHECKING:
    from torchtitan_npu_lite.models.deepseek_v3_2.model import (
        Attention,
        DeepSeekV32Model,
    )
    ...
    *,
    ...
    inner_cfg.sharding_config = ShardingConfig(
        in_src_shardings={
            ...
            # TODO(sdmyzlp): Current spmd_types doesn't support redistributing
            # along multiple axis, R->I@TP is crafted manually as a workaround.
